...
FIRST_TEXT = f"""★ 𝙍𝗮𝙣𝙖𝙓𝙎𝙥𝙖𝙢 𝙃𝙚𝙡𝙥 𝙈𝙚𝙣𝙪 ★

**» ʙᴏᴛ ᴄᴏᴍᴍᴀɴᴅꜱ:** [ᴄʟɪᴄᴋ ʜᴇʀᴇ](https://t.me/RANA_societyyyy)
**» ʀᴀɪᴅ ᴄᴏᴍᴍᴀɴᴅꜱ:** [ᴄʟɪᴄᴋ ʜᴇʀᴇ](https://t.me/RANA_societyyyy)
**» ꜱᴘᴀᴍ ᴄᴏᴍᴍᴀɴᴅꜱ:** [ᴄʟɪᴄᴋ ʜᴇʀᴇ](https://t.me/RANA_societyyyy)
**» ᴅᴍ ᴄᴏᴍᴍᴀɴᴅꜱ:** [ᴄʟɪᴄᴋ ʜᴇʀᴇ](https://t.me/RANA_societyyyy)"""
...
async def add_sudo(_, message: Message):
       ...
       if len(sudousers) > 0:
              ...
              newsudo = f"{target}"
       await ok.edit(f"» **𝐍ᴇᴡ ꜱᴜᴅᴏ ᴜꜱᴇʀ**: `{target}`\n» `𝐑ᴇsᴛᴀʀᴛɪɴɢ ʙᴏᴛ...`")
